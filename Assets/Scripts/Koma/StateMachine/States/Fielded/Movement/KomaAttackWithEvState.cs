...
public class KomaAttackWithEvState : KomaFieldedState
{
    private Vector2Int prePosition;
    private ShogiGrid grid;
    private AttackSetting attackData;

    public KomaAttackWithEvState(KomaMovementStateMachine komaMovementStateMachine) : base(komaMovementStateMachine)
    {
